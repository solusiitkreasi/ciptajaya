...
function calculateRowProductData(quantity) {
    ...
    if (tax_method[rowindex] == 1) {
        var nup = row_product_price - product_discount[rowindex];
        var net_unit_price =  nup + product_unit_cost[rowindex];
        ...
        var stu = row_product_price - product_discount[rowindex];
        var sub_total_unit =  stu + product_unit_cost[rowindex];
    ...
    // calculate unit cost
    localStorageProductUnitCost.splice(rowindex, 1, (product_unit_cost[rowindex] * quantity).toFixed(2));
