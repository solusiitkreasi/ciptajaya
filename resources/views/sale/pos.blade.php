...
function calculateRowProductData(quantity) {
    ...
    if (tax_method[rowindex] == 1) {
        var net_unit_price = product_unit_cost[rowindex] + row_product_price - product_discount[rowindex];
        ...
        var sub_total_unit = product_unit_cost[rowindex] + row_product_price - product_discount[rowindex];
